...
val IconPack.WaterDropWhite: ImageVector
    get() {
        if (_WaterDropWhite != null) {
            return _WaterDropWhite!!
        }
        _WaterDropWhite = ImageVector.Builder(
            name = "WaterDropWhite",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
...
private var _WaterDropWhite: ImageVector? = null
