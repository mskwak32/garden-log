...
val IconPack.SettingsBlack: ImageVector
    get() {
        if (_SettingsBlack != null) {
            return _SettingsBlack!!
        }
        _SettingsBlack = ImageVector.Builder(
            name = "SettingsBlack",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
...
private var _SettingsBlack: ImageVector? = null
