...
val IconPack.WaterDropBlue: ImageVector
    get() {
        if (_WaterDropBlue != null) {
            return _WaterDropBlue!!
        }
        _WaterDropBlue = ImageVector.Builder(
            name = "WaterDropBlue",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(fill = SolidColor(Color(0xFF53A0FF))) {
                moveTo(12f, 2f)
...
private var _WaterDropBlue: ImageVector? = null
